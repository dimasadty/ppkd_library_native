...
$isAdmin = ($_SESSION['role'] == 'admin'); // Adjust according to your role system
...
<head>
  ...
  <title>PPKD Jakarta Pusat - Dashboard</title>
  <!-- plugins:css -->
...
<body class="with-welcome-text">
  ...
  <?php include 'inc/navbarinstructor.php'; ?>
  <!-- partial -->
  <div class="container-fluid page-body-wrapper">
    <!-- partial:partials/_sidebar.html -->
    <?php include 'inc/sidebarinstructor.php'; ?>
    <!-- partial -->
    <!-- main panel -->
